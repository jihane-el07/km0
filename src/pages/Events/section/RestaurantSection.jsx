...
const RestaurantSection = () => {
  ...
  const handleBookNow = (eventType) => {
    navigate('/Book-Table', { state: { type: 'event', eventType } });
  };
      ...
      <div className={styles.mainContent}>
        <div className={styles.textSection}>
          ...
          <div className={styles.btn}>
            <button
              className={`${styles.btnPrimary} font-lora`}
              onClick={() => handleBookNow('wedding')}
            >
              Book Now
            </button>
          </div>
      ...
      <div className={styles.mainContent2}>
        <div className={styles.textSection}>
          ...
          <div className={styles.btn}>
            <button
              className={`${styles.btnPrimary} font-lora`}
              onClick={() => handleBookNow('birthday')}
            >
              Book Now
            </button>
          </div>
      ...
      <div className={styles.mainContent}>
        <div className={styles.textSection}>
          ...
          <div className={styles.btn}>
            <button
              className={`${styles.btnPrimary} font-lora`}
              onClick={() => handleBookNow('corporate')}
            >
              Book Now
            </button>
          </div>
