...
export default function Produits() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: "COOKING AIDS",
      description:
        "Discover our new range of culinary aids designed to support your creative recipes and elevate your cooking experience!",
    },
  ];
  ...
  return (
    <section className={styles.featuresSection}>
      <div className={styles.heading}>
        <h3 className={styles.scriptHeading}>Crafted with Passion, Served with Delight</h3>
      ...
      <div className={styles.featuresGrid}>
        {features.map((feature, index) => (
          <div key={index} className={styles.featureCard}>
            <img className={styles.featureImage} src={feature.image} alt={feature.title} />
            <Link className={styles.featureTitle} to="/">{feature.title}</Link>
